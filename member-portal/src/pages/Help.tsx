...
const Help: React.FC = () => {
  ...
  const handleViewDocs = () => {
    ...
    const readmeUrl =
      "https://raw.githubusercontent.com/AyushSharmaaa/hospital-management-system/main/README.md";
          ...
          newWindow.document.write(`
            ...
            <body>
                ...
                <div class="section">
                    ...
                    <p><strong>GitHub:</strong> https://github.com/AyushSharmaaa/hospital-management-system</p>
                </div>
            </body>
            </html>
          `);
